...
<body class="content">
    ...
    <section class="py-5">
        <div class="container text-justify">
            <h2 class="font-weight-light">Eat.lk's About Us</h2>
            <p> Eat.lk is sub-application in Food Delivery Management System(FDMS) family.
            We built up food ordering and take-out into simple phases to make communication between 
            customers and food vendors easier. This is to assure client happiness and to give the finest facility
             and automation in the most straightforward manner feasible. In 2021, Eat.lk wants to be the number one
              user option for meal ordering and management.
            </p>
        </div>
        <div class="container pt-4 text-justify">
            <h2 class="font-weight-light">Eat.lk's Policy</h2>
            <p>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" class="form-control" id="usr" name="username" required placeholder="Create a username">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="password" class="form-control" id="pwd" name="password" required placeholder="Choose a password">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="password" class="form-control" id="c_pwd" name="confirm_password" required placeholder="Confirm password">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="input-group mb-2">
                                    ...
                                    <textarea class="form-control" rows="3" id="address" name="address" required placeholder="Enter your address"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" class="form-control" id="shop_name" name="shop_name" required placeholder="Enter shop name">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" class="form-control" id="shop_username" name="shop_username" required placeholder="Create a shop username">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="password" class="form-control" id="shop_password" name="shop_password" required placeholder="Choose a password">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="password" class="form-control" id="shop_confirm_password" name="shop_confirm_password" required placeholder="Confirm password">
                                </div>
                            </div>
                        </div>
                    </div>
